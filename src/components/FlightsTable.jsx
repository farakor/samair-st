...
export default function FlightsTable() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Заголовок таблицы */}
      <div className="p-4 sm:p-6 bg-white border-b pt-16 lg:pt-6">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Таблица рейсов</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-max">
              <thead className="bg-gray-50">
                <tr>
                  <th className="sticky top-0 bg-gray-50 px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">
                    Дата
                  </th>
                  <th className="sticky top-0 bg-gray-50 px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">
                    Тип ВС
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {currentData.length === 0 ? (
                  <tr>
                    <td colSpan="12" className="px-3 sm:px-6 py-8 text-center">
